...
CORE.WipeCounter = function(entry, counterType, mechanic)
  entry.counter[counterType] = entry.counter[counterType] or {}
  entry.counter[counterType][mechanic] = 0
  return entry.counter[counterType][mechanic]
end
